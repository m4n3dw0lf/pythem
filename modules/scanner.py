...
class Scanner(object):
	...
	def __init__(self,target,interface,mode):
		...
		self.portRange = [21,22,23,25,53,57,79,80,107,109,110,111,115,118,123,135,137,138,139,161,389,443,445,465,995,1025,1026,1027,1035,1234,1243,3000,3128,3306,3389,3872,4444,5900,6000,6005,6346,6667,6667,8080,8443,8888,9999,12345,12346,16660,18753,20034,20432,20433,27374,27444,27665,31335,31337,33270,33567,33568,40421,60008,65000]		
		self.mode = mode
